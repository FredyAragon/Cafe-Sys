...
class Orders(models.Model):
    ...
    user        = models.ForeignKey('Users', on_delete=models.CASCADE, related_name='orders', db_column='user_id')
    location    = models.ForeignKey('Locations', on_delete=models.PROTECT, related_name='orders', db_column='location_id')
    ...
    created_id  = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, related_name='orders_created', db_column='created_id')
    modified_id = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, related_name='orders_modified', db_column='modified_id')
