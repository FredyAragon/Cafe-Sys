...
class Locations(models.Model):
    ...
    user        = models.ForeignKey('Users', on_delete=models.CASCADE, related_name='locations', db_column='user_id')
    ...
    created_id  = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, related_name='locations_created', db_column='created_id')
    modified_id = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, related_name='locations_modified', db_column='modified_id')
